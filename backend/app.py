...
# List of symptoms in exact training column order
symptoms_list = [
...
def predict():
    try:
        ...
        print("Received input:", data)  # Debugging line

        # Arrange the input in same order as training data
        input_features = [data.get(symptom, 0) for symptom in symptoms_list]
